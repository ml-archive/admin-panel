...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nodes-vapor/bootstrap.git", from: "3.0.0-beta"),
        .package(url: "https://github.com/nodes-vapor/flash.git", from: "5.0.0-beta"),
        .package(url: "https://github.com/nodes-vapor/paginator.git", from: "3.1.0"),
